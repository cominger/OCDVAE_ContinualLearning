...
python main.py --dataset Flower17 -j 3 -p 64 -b 128 -a WRN_gan --wrn-depth 26 --gan --visualization-epoch 50 --incremental-data True --num-base-tasks 1 --num-increment-tasks 1 --num-dis-feature 64 --openset-generative-replay True -genreplay True --epoch 1000 --var-latent-dim 64  -noise 0 --l1-weight 3 --var-gan-weight 1 --FID
